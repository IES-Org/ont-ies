...
!!! abstract "Core Principle"
    BORO is not concerned with the **words** used to describe concepts. Instead, it focuses on identifying things by their **extent**—the space and time they occupy.
