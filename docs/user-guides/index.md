...
- [Getting Started](#getting-started)
  ...
  - [3. Practical Application](#3-practical-application)
- [User Guide Index](#user-guide-index)
  - [Introduction to IES](#introduction-to-ies)
  - [What is an Ontology?](#what-is-an-ontology)
  - [4D Ontology Approach](#4d-ontology-approach)
  - [BORO Methodology](#boro-methodology)
  - [Instantiation Patterns](#instantiation-patterns)
  - [Extending IES](#extending-ies)
- [Audience-Specific Pathways](#audience-specific-pathways)
  - [For Implementers](#for-implementers)
  - [For Information Architects](#for-information-architects)
  - [For Data Modellers](#for-data-modellers)
  - [For Ontology Engineers](#for-ontology-engineers)
...
For users new to IES, the following learning path is recommended:
